//! Pi oracle for [`pirust_tui::Text`] (feat-006 Wave 5).
//!
//! Replays every record of `tests/fixtures/pi/tui/text.cases.jsonl` —
//! captured by executing real Pi's `packages/tui/src/components/text.ts` —
...
fn fixture_path() -> PathBuf {
    PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../../tests/fixtures/pi/tui/text.cases.jsonl")
}
...
#[test]
fn every_text_record_matches_pi() {
